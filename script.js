...
const mindprintDescriptions = {
    ...
    5: { title: "Si Kreatif Reflektif", intisari: "Pemikir abstrak dengan imajinasi sangat luas yang didominasi otak kanan atas dengan kemudi dari dalam. Anda adalah visioner yang mementingkan orisinalitas serta kualitas ide melampaui zaman melalui konsep dan filosofi.", successHabit: "Menyusun Master Plan jangka panjang yang mendetail melalui inovasi berkelanjutan.", relationship: "Sangat selektif dalam memilih lingkungan sosial dan menghargai privasi pikiran.", communication: "Puitis, penuh simbol, filosofis, dan cenderung selektif.", positif: "Strategis, perfeksionis ide, visioner.", negatif: "Tertutup, lambat beraksi, skeptis.", motivasi: "Hargai orisinalitas idenya, berikan waktu dan ruang privat, serta dukung visi jangka panjangnya.", karir: "Arsitek, Penulis, Strategist, Ilmuwan, Seniman Konseptual." },
    6: { title: "Si Kreatif Ekspresif", intisari: "Trendsetter yang sangat optimis, penuh antusiasme, dan selalu terlihat kekinian. Anda memiliki intuisi bisnis yang sangat tajam dalam melihat peluang keuntungan serta pandai menularkan visi dan semangat kepada tim.", successHabit: "Membangun networking luas dan terus memperbarui ilmu pengetahuan.", relationship: "Membutuhkan pasangan yang mendukung mimpi-mimpi besar dan ide kreatifnya.", communication: "Ekspresif, penuh semangat, dan persuasif dengan analogi masa depan.", positif: "Kreatif, optimis, inovatif.", negatif: "Mudah bosan, tidak konsisten, kurang fokus.", motivasi: "Libatkan dalam proyek inovatif, berikan panggung presentasi, serta insentif berbasis profit.", karir: "Inovator, Arsitek, Desainer, Kreator Konten, Pengusaha." },
