...
const mindprintDescriptions = {
    ...
    3: { 
        ...
        intisari: "Individu yang paling mandiri dan mendalam secara intelektual dengan dominasi otak kiri atas yang digerakkan dari dalam. Anda adalah sosok yang sangat logis, objektif, dan perfeksionis dalam validasi data, di mana segala informasi harus melewati filter logika yang ketat.", 
        ...
        motivasi: "Berikan akses terhadap data/ilmu baru, hargai kemandiriannya, dan libatkan dalam sistem logis.",
    ...
    4: { 
        ...
        positif: "Kemampuan manajerial hebat, tegas, berwibawa, serta sangat organisatoris.", 
    ...
    6: { 
        ...
        intisari: "Trendsetter yang sangat optimis, penuh antusiasme, dan selalu terlihat kekinian. Anda memiliki intuisi bisnis yang sangat tajam dalam melihat peluang keuntungan serta pandai menularkan visi dan semangat kepada tim agar percaya pada mimpi besar.", 
        ...
        positif: "Intuisi bisnis kuat, sangat inovatif, multitalenta, serta penyebar antusiasme.", 
    ...
    7: { 
        ...
        intisari: "Pribadi paling idealis yang digerakkan sepenuhnya oleh hati dengan keyakinan prinsip yang tidak tergoyahkan. Anda memiliki integritas dan loyalitas yang sangat tinggi, setia pada janji, serta selalu menjadi pembawa ketenangan dalam tim.", 
    ...
    8: { 
        ...
        intisari: "Sosok 'Magnet Sosial' dengan kharisma tinggi dan kemampuan komunikasi persuasif yang memikat. Anda adalah ahli dalam memahami psikologi massa, sangat hebat dalam meyakinkan orang lain, serta mampu membangkitkan semangat tim yang jatuh.", 
        ...
        positif: "Sangat kharismatik, inspiratif, serta memiliki kemampuan networking luas.", 
        negatif: "Haus pengakuan orang, terkadang manipulatif, serta mudah sekali terpengaruh.", 
        motivasi: "Berikan apresiasi publik (pujian di depan orang), jadikan juru bicara, dan dukungan emosional.",
        karir: "Politisi, Motivator, PR, Sales Manager, Presenter." 
    },
    9: { 
        title: "Si Adaptif", 
        intisari: "Generalis responsif yang serba bisa dan sangat mendambakan cinta damai. Anda adalah 'jembatan' fleksibel yang mampu menghubungkan berbagai pilar lainnya secara naluriah, memiliki kecepatan refleks yang luar biasa.", 
        ...
        motivasi: "Berikan ketenangan pikiran, hindari konflik menekan, yakinkan kehadirannya bermanfaat.",
