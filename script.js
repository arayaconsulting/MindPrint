...
const mindprintDescriptions = {
    ...
    6: { title: "Si Kreatif Ekspresif", intisari: "Trendsetter yang sangat optimis, penuh antusiasme, dan selalu terlihat kekinian. Anda memiliki intuisi bisnis yang sangat tajam dalam melihat peluang keuntungan serta pandai menularkan visi dan semangat kepada tim agar percaya pada mimpi besar.", successHabit: "Membangun networking luas dan melatih ketekunan untuk menuntaskan proyek besar.", relationship: "Membutuhkan dukungan penuh terhadap mimpi-mimpi besar dan ide kreatifnya.", communication: "Ekspresif, penuh semangat, dan persuasif dengan analogi masa depan.", positif: "Intuisi bisnis kuat, sangat inovatif, multitalenta, serta penyebar antusiasme.", negatif: "Kurang fokus pada detail, ceroboh, serta berani risiko tanpa perhitungan.", motivasi: "Libatkan dalam proyek inovatif, berikan panggung presentasi, serta insentif berbasis profit.", karir: "Pengusaha, Investor, Desainer, Kreator Konten, Konsultan Kreatif." },
