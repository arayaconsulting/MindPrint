...
const mindprintDescriptions = {
    1: { 
        ...
        successHabit: "Mantra: 'Logika dan Otoritas'. Kunci Sukses: Keahlian Teknis and Kekuasaan. Sukses jika memiliki otoritas atau kendali atas sistem. Terus asah otak dengan belajar ilmu-ilmu baru (ta'allum) agar posisi tawar tetap tinggi.", 
    ...
    8: { 
        ...
        motivasi: "Berikan otoritas, tanggung jawab memimpin tim besar, serta pengakuan atas jabatan and prestasi.", 
        karir: "CEO/Direktur, Manajer Proyek, Politisi, Hakim, Pengusaha Skala Korporasi.", 
        study: "Diskusi Terstruktur (debat logis), Menjadi Pengajar (menjelaskan kembali materi), and mempelajari Studi Kasus Bisnis besar." 
    },
    9: { 
        ...
        motivasi: "Berikan ketenangan pikiran, hindari konflik menekan, and yakinkan bahwa kehadirannya sangat bermanfaat.", 
        karir: "Pekerja Sosial, Seniman Multitalenta, Bagian Umum (GA), Relawan, Medis Darurat.", 
        study: "Suasana Tenang (Relaksasi), Belajar melalui Ringkasan (ikhtisar/big picture), and Belajar Sambil Melakukan." 
    }
};
