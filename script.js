 ...
 * OWNER: ALI MAHFUD
 * FINAL STABLE SCRIPT BASED ON IDEAL LAYOUT ENGINE
 */
...
const mindprintDescriptions = {
    ...
    6: { title: "Si Kreatif Ekspresif", intisari: "Trendsetter yang sangat optimis, penuh antusiasme, dan selalu terlihat kekinian. Anda adalah inovator visioner yang mampu melihat peluang masa depan dan merakitnya menjadi terobosan bisnis yang menguntungkan.", successHabit: "Membangun networking luas dan terus memperbarui ilmu pengetahuan.", relationship: "Membutuhkan pasangan yang mendukung mimpi-mimpi besar dan ide kreatifnya.", communication: "Ekspresif, penuh semangat, dan persuasif dengan analogi masa depan.", positif: "Kreatif, optimis, inovatif.", negatif: "Mudah bosan, tidak konsisten, kurang fokus.", motivasi: "Libatkan dalam proyek inovatif, berikan panggung presentasi, serta insentif berbasis profit.", karir: "Inovator, Arsitek, Desainer, Kreator Konten, Pengusaha." },
...
function startScanning(e) {
    ...
    text.textContent = `Memindai ${fingers[currentFingerIndex]}... JANGAN DILEPAS!`;
...
function cancelScanning() {
    ...
    document.getElementById('scan-text').textContent = "GAGAL! Jari terlepas. Tempelkan kembali.";
}

const scannerElement = document.getElementById('fingerprint-scanner');
if(scannerElement) {
    scannerElement.addEventListener('mousedown', startScanning);
    scannerElement.addEventListener('touchstart', startScanning);
