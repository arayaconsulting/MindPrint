...
document.getElementById('download-btn').addEventListener('click', () => {
    ...
    const opt = {
        ...
        html2canvas: { 
            ...
            useCORS: true, 
            logging: false,
            // Menghilangkan paksaan piksel agar mengikuti unit mm di HTML
            scrollX: 0,
            scrollY: 0
        },
